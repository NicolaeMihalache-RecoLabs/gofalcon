...
import (
	...
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/alerts"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/api_integrations"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/certificate_based_exclusions"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/cloud_connect_aws"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/cloud_snapshots"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/compliance_assessments"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/configuration_assessment"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/configuration_assessment_evaluation_logic"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/container_alerts"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/container_detections"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/container_images"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/container_packages"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/container_vulnerabilities"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/cspg_iacapi"
	...
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/custom_storage"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/d4c_registration"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/datascanner"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/detects"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/device_control_policies"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/discover"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/discover_iot"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/drift_indicators"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/event_schema"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/event_streams"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/exposure_management"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/falcon_complete_dashboard"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/falcon_container"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/falcon_container_cli"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/falcon_container_image"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/falconx_sandbox"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/field_schema"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/filevantage"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/firewall_management"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/firewall_policies"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/foundry_logscale"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/host_group"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/host_migration"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/hosts"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/identity_entities"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/identity_protection"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/image_assessment_policies"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/incidents"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/installation_tokens"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/installation_tokens_settings"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/intel"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/ioa_exclusions"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/ioc"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/iocs"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/kubernetes_protection"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/malquery"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/message_center"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/ml_exclusions"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/mobile_enrollment"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/mssp"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/oauth2"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/ods"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/overwatch_dashboard"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/prevention_policies"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/quarantine"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/quick_scan"
	...
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/real_time_response_audit"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/recon"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/report_executions"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/response_policies"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/runtime_detections"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/sample_uploads"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/scheduled_reports"
	...
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/sensor_visibility_exclusions"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/spotlight_evaluation_logic"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/spotlight_vulnerabilities"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/tailored_intelligence"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/threatgraph"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/unidentified_containers"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/user_management"
	"github.com/NicolaeMihalache-RecoLab/gofalcon/falcon/client/workflows"
