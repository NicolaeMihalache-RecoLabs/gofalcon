...
func (o *GetActionsV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetActionsV1OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewGetActionsV1BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 401:
		result := NewGetActionsV1Unauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 403:
		result := NewGetActionsV1Forbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 429:
		result := NewGetActionsV1TooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewGetActionsV1InternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /recon/entities/actions/v1] GetActionsV1", response, response.Code())
	}
}

// NewGetActionsV1OK creates a GetActionsV1OK with default headers values
func NewGetActionsV1OK() *GetActionsV1OK {
	return &GetActionsV1OK{}
}
...
func (o *GetActionsV1OK) Error() string {
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] getActionsV1OK  %+v", 200, o.Payload)
}
...
func (o *GetActionsV1OK) GetPayload() *models.DomainActionEntitiesResponseV1 {
	return o.Payload
}

func (o *GetActionsV1OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetActionsV1BadRequest) Error() string {
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] getActionsV1BadRequest  %+v", 400, o.Payload)
}
...
func (o *GetActionsV1BadRequest) GetPayload() *models.DomainErrorsOnly {
	return o.Payload
}

func (o *GetActionsV1BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetActionsV1Unauthorized() *GetActionsV1Unauthorized {
	return &GetActionsV1Unauthorized{}
}
...
func (o *GetActionsV1Unauthorized) Error() string {
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] getActionsV1Unauthorized  %+v", 401, o.Payload)
}
...
func (o *GetActionsV1Unauthorized) GetPayload() *models.DomainErrorsOnly {
	return o.Payload
}

func (o *GetActionsV1Unauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetActionsV1Forbidden) Error() string {
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] getActionsV1Forbidden  %+v", 403, o.Payload)
}
...
func (o *GetActionsV1Forbidden) GetPayload() *models.DomainErrorsOnly {
	return o.Payload
}

func (o *GetActionsV1Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetActionsV1TooManyRequests() *GetActionsV1TooManyRequests {
	return &GetActionsV1TooManyRequests{}
}
...
func (o *GetActionsV1TooManyRequests) Error() string {
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] getActionsV1TooManyRequests  %+v", 429, o.Payload)
}
...
func (o *GetActionsV1TooManyRequests) GetPayload() *models.MsaReplyMetaOnly {
	return o.Payload
}

func (o *GetActionsV1TooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetActionsV1InternalServerError() *GetActionsV1InternalServerError {
	return &GetActionsV1InternalServerError{}
}
...
func (o *GetActionsV1InternalServerError) Code() int {
	return 500
}

func (o *GetActionsV1InternalServerError) Error() string {
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] getActionsV1InternalServerError  %+v", 500, o.Payload)
}

func (o *GetActionsV1InternalServerError) String() string {
	return fmt.Sprintf("[GET /recon/entities/actions/v1][%d] getActionsV1InternalServerError  %+v", 500, o.Payload)
}

func (o *GetActionsV1InternalServerError) GetPayload() *models.DomainErrorsOnly {
	return o.Payload
}

func (o *GetActionsV1InternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
