...
func (o *DeleteRulesV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /recon/entities/rules/v1] DeleteRulesV1", response, response.Code())
	}
}
...
func (o *DeleteRulesV1TooManyRequests) Code() int {
	return 429
}
...
func (o *DeleteRulesV1InternalServerError) Code() int {
	return 500
}
