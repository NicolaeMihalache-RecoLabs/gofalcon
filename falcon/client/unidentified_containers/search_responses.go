...
func (o *SearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /container-security/combined/unidentified-containers/v1] Search", response, response.Code())
	}
}
...
type SearchOK struct {
	...
	Payload *models.UnidentifiedcontainersUnidentifiedContainerAPIResponse
}
...
func (o *SearchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.UnidentifiedcontainersUnidentifiedContainerAPIResponse)
