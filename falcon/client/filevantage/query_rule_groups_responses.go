...
func (o *QueryRuleGroupsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /filevantage/queries/rule-groups/v1] queryRuleGroups", response, response.Code())
	}
}
...
func (o *QueryRuleGroupsOK) Error() string {
	return fmt.Sprintf("[GET /filevantage/queries/rule-groups/v1][%d] queryRuleGroupsOK  %+v", 200, o.Payload)
}
...
func (o *QueryRuleGroupsBadRequest) Error() string {
	return fmt.Sprintf("[GET /filevantage/queries/rule-groups/v1][%d] queryRuleGroupsBadRequest  %+v", 400, o.Payload)
}
...
func (o *QueryRuleGroupsForbidden) Error() string {
	return fmt.Sprintf("[GET /filevantage/queries/rule-groups/v1][%d] queryRuleGroupsForbidden  %+v", 403, o.Payload)
}
...
func (o *QueryRuleGroupsTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /filevantage/queries/rule-groups/v1][%d] queryRuleGroupsTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *QueryRuleGroupsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /filevantage/queries/rule-groups/v1][%d] queryRuleGroupsInternalServerError  %+v", 500, o.Payload)
}
