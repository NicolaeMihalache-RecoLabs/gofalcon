...
func (o *SearchAndReadDriftIndicatorEntitiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSearchAndReadDriftIndicatorEntitiesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 403:
		result := NewSearchAndReadDriftIndicatorEntitiesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 429:
		result := NewSearchAndReadDriftIndicatorEntitiesTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewSearchAndReadDriftIndicatorEntitiesInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /container-security/combined/drift-indicators/v1] SearchAndReadDriftIndicatorEntities", response, response.Code())
	}
}
...
func NewSearchAndReadDriftIndicatorEntitiesOK() *SearchAndReadDriftIndicatorEntitiesOK {
	return &SearchAndReadDriftIndicatorEntitiesOK{}
}
...
func (o *SearchAndReadDriftIndicatorEntitiesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewSearchAndReadDriftIndicatorEntitiesForbidden() *SearchAndReadDriftIndicatorEntitiesForbidden {
	return &SearchAndReadDriftIndicatorEntitiesForbidden{}
}
...
func (o *SearchAndReadDriftIndicatorEntitiesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewSearchAndReadDriftIndicatorEntitiesTooManyRequests() *SearchAndReadDriftIndicatorEntitiesTooManyRequests {
	return &SearchAndReadDriftIndicatorEntitiesTooManyRequests{}
}
...
func (o *SearchAndReadDriftIndicatorEntitiesTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewSearchAndReadDriftIndicatorEntitiesInternalServerError() *SearchAndReadDriftIndicatorEntitiesInternalServerError {
	return &SearchAndReadDriftIndicatorEntitiesInternalServerError{}
}
...
func (o *SearchAndReadDriftIndicatorEntitiesInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
