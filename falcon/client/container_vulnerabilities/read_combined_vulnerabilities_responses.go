...
func (o *ReadCombinedVulnerabilitiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReadCombinedVulnerabilitiesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 403:
		result := NewReadCombinedVulnerabilitiesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 429:
		result := NewReadCombinedVulnerabilitiesTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewReadCombinedVulnerabilitiesInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /container-security/combined/vulnerabilities/v1] ReadCombinedVulnerabilities", response, response.Code())
	}
}
...
func NewReadCombinedVulnerabilitiesOK() *ReadCombinedVulnerabilitiesOK {
	return &ReadCombinedVulnerabilitiesOK{}
}
...
func (o *ReadCombinedVulnerabilitiesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.VulnerabilitiesAPICombinedVulnerability)
...
func NewReadCombinedVulnerabilitiesForbidden() *ReadCombinedVulnerabilitiesForbidden {
	return &ReadCombinedVulnerabilitiesForbidden{}
}
...
func (o *ReadCombinedVulnerabilitiesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewReadCombinedVulnerabilitiesTooManyRequests() *ReadCombinedVulnerabilitiesTooManyRequests {
	return &ReadCombinedVulnerabilitiesTooManyRequests{}
}
...
func (o *ReadCombinedVulnerabilitiesTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewReadCombinedVulnerabilitiesInternalServerError() *ReadCombinedVulnerabilitiesInternalServerError {
	return &ReadCombinedVulnerabilitiesInternalServerError{}
}
...
func (o *ReadCombinedVulnerabilitiesInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
