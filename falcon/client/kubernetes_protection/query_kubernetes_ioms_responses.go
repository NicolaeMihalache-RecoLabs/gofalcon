...
func (o *QueryKubernetesIomsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewQueryKubernetesIomsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 403:
		result := NewQueryKubernetesIomsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 429:
		result := NewQueryKubernetesIomsTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewQueryKubernetesIomsInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /container-security/queries/kubernetes-ioms/v1] QueryKubernetesIoms", response, response.Code())
	}
}
...
func (o *QueryKubernetesIomsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewQueryKubernetesIomsForbidden() *QueryKubernetesIomsForbidden {
	return &QueryKubernetesIomsForbidden{}
}
...
func (o *QueryKubernetesIomsForbidden) Code() int {
	return 403
}
...
func (o *QueryKubernetesIomsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewQueryKubernetesIomsTooManyRequests() *QueryKubernetesIomsTooManyRequests {
	return &QueryKubernetesIomsTooManyRequests{}
}
...
func (o *QueryKubernetesIomsTooManyRequests) IsSuccess() bool {
	return false
}
...
func (o *QueryKubernetesIomsTooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the query kubernetes ioms too many requests response
func (o *QueryKubernetesIomsTooManyRequests) Code() int {
	return 429
}
...
func (o *QueryKubernetesIomsTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewQueryKubernetesIomsInternalServerError() *QueryKubernetesIomsInternalServerError {
	return &QueryKubernetesIomsInternalServerError{}
}
...
func (o *QueryKubernetesIomsInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this query kubernetes ioms internal server error response has a 3xx status code
func (o *QueryKubernetesIomsInternalServerError) IsRedirect() bool {
	return false
}
...
func (o *QueryKubernetesIomsInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the query kubernetes ioms internal server error response
func (o *QueryKubernetesIomsInternalServerError) Code() int {
	return 500
}
...
func (o *QueryKubernetesIomsInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
