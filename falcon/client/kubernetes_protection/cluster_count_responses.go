...
func (o *ClusterCountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewClusterCountOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 403:
		result := NewClusterCountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 429:
		result := NewClusterCountTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewClusterCountInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /container-security/aggregates/clusters/count/v1] ClusterCount", response, response.Code())
	}
}

// NewClusterCountOK creates a ClusterCountOK with default headers values
func NewClusterCountOK() *ClusterCountOK {
	return &ClusterCountOK{}
}
...
func (o *ClusterCountOK) Error() string {
	return fmt.Sprintf("[GET /container-security/aggregates/clusters/count/v1][%d] clusterCountOK  %+v", 200, o.Payload)
}
...
func (o *ClusterCountOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ClusterCountForbidden) Error() string {
	return fmt.Sprintf("[GET /container-security/aggregates/clusters/count/v1][%d] clusterCountForbidden  %+v", 403, o.Payload)
}
...
func (o *ClusterCountForbidden) GetPayload() *models.MsaReplyMetaOnly {
	return o.Payload
}

func (o *ClusterCountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewClusterCountTooManyRequests() *ClusterCountTooManyRequests {
	return &ClusterCountTooManyRequests{}
}
...
func (o *ClusterCountTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /container-security/aggregates/clusters/count/v1][%d] clusterCountTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *ClusterCountTooManyRequests) GetPayload() *models.MsaReplyMetaOnly {
	return o.Payload
}

func (o *ClusterCountTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewClusterCountInternalServerError() *ClusterCountInternalServerError {
	return &ClusterCountInternalServerError{}
}
...
func (o *ClusterCountInternalServerError) Code() int {
	return 500
}

func (o *ClusterCountInternalServerError) Error() string {
	return fmt.Sprintf("[GET /container-security/aggregates/clusters/count/v1][%d] clusterCountInternalServerError  %+v", 500, o.Payload)
}

func (o *ClusterCountInternalServerError) String() string {
	return fmt.Sprintf("[GET /container-security/aggregates/clusters/count/v1][%d] clusterCountInternalServerError  %+v", 500, o.Payload)
}

func (o *ClusterCountInternalServerError) GetPayload() *models.CoreEntitiesResponse {
	return o.Payload
}

func (o *ClusterCountInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
