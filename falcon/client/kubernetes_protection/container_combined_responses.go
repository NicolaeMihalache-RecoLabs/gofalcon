...
func (o *ContainerCombinedReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewContainerCombinedOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 403:
		result := NewContainerCombinedForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 429:
		result := NewContainerCombinedTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewContainerCombinedInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /container-security/combined/containers/v1] ContainerCombined", response, response.Code())
	}
}
...
func (o *ContainerCombinedOK) Error() string {
	return fmt.Sprintf("[GET /container-security/combined/containers/v1][%d] containerCombinedOK  %+v", 200, o.Payload)
}
...
func (o *ContainerCombinedOK) GetPayload() *models.ModelsContainerEntityResponse {
	return o.Payload
}

func (o *ContainerCombinedOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ModelsContainerEntityResponse)
...
func NewContainerCombinedForbidden() *ContainerCombinedForbidden {
	return &ContainerCombinedForbidden{}
}
...
func (o *ContainerCombinedForbidden) Error() string {
	return fmt.Sprintf("[GET /container-security/combined/containers/v1][%d] containerCombinedForbidden  %+v", 403, o.Payload)
}
...
func (o *ContainerCombinedForbidden) GetPayload() *models.MsaReplyMetaOnly {
	return o.Payload
}

func (o *ContainerCombinedForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewContainerCombinedTooManyRequests() *ContainerCombinedTooManyRequests {
	return &ContainerCombinedTooManyRequests{}
}
...
func (o *ContainerCombinedTooManyRequests) Code() int {
	return 429
}

func (o *ContainerCombinedTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /container-security/combined/containers/v1][%d] containerCombinedTooManyRequests  %+v", 429, o.Payload)
}

func (o *ContainerCombinedTooManyRequests) String() string {
	return fmt.Sprintf("[GET /container-security/combined/containers/v1][%d] containerCombinedTooManyRequests  %+v", 429, o.Payload)
}

func (o *ContainerCombinedTooManyRequests) GetPayload() *models.MsaReplyMetaOnly {
	return o.Payload
}

func (o *ContainerCombinedTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewContainerCombinedInternalServerError() *ContainerCombinedInternalServerError {
	return &ContainerCombinedInternalServerError{}
}
...
func (o *ContainerCombinedInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this container combined internal server error response has a 3xx status code
func (o *ContainerCombinedInternalServerError) IsRedirect() bool {
	return false
}
...
func (o *ContainerCombinedInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the container combined internal server error response
func (o *ContainerCombinedInternalServerError) Code() int {
	return 500
}

func (o *ContainerCombinedInternalServerError) Error() string {
	return fmt.Sprintf("[GET /container-security/combined/containers/v1][%d] containerCombinedInternalServerError  %+v", 500, o.Payload)
}

func (o *ContainerCombinedInternalServerError) String() string {
	return fmt.Sprintf("[GET /container-security/combined/containers/v1][%d] containerCombinedInternalServerError  %+v", 500, o.Payload)
}

func (o *ContainerCombinedInternalServerError) GetPayload() *models.CoreEntitiesResponse {
	return o.Payload
}

func (o *ContainerCombinedInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
