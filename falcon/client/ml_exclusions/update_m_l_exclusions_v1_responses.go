...
func (o *UpdateMLExclusionsV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PATCH /policy/entities/ml-exclusions/v1] updateMLExclusionsV1", response, response.Code())
	}
}
...
func (o *UpdateMLExclusionsV1OK) GetPayload() *models.ExclusionsRespV1 {
	return o.Payload
}
...
func (o *UpdateMLExclusionsV1BadRequest) Code() int {
	return 400
}
...
func (o *UpdateMLExclusionsV1BadRequest) String() string {
	return fmt.Sprintf("[PATCH /policy/entities/ml-exclusions/v1][%d] updateMLExclusionsV1BadRequest  %+v", 400, o.Payload)
}

func (o *UpdateMLExclusionsV1BadRequest) GetPayload() *models.ExclusionsRespV1 {
	return o.Payload
}
...
func (o *UpdateMLExclusionsV1Forbidden) Code() int {
	return 403
}
...
func (o *UpdateMLExclusionsV1Forbidden) String() string {
	return fmt.Sprintf("[PATCH /policy/entities/ml-exclusions/v1][%d] updateMLExclusionsV1Forbidden  %+v", 403, o.Payload)
}
...
func (o *UpdateMLExclusionsV1TooManyRequests) IsSuccess() bool {
	return false
}
...
func (o *UpdateMLExclusionsV1TooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the update m l exclusions v1 too many requests response
func (o *UpdateMLExclusionsV1TooManyRequests) Code() int {
	return 429
}
...
func (o *UpdateMLExclusionsV1InternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update m l exclusions v1 internal server error response has a 3xx status code
func (o *UpdateMLExclusionsV1InternalServerError) IsRedirect() bool {
	return false
}
...
func (o *UpdateMLExclusionsV1InternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the update m l exclusions v1 internal server error response
func (o *UpdateMLExclusionsV1InternalServerError) Code() int {
	return 500
}
...
func (o *UpdateMLExclusionsV1InternalServerError) String() string {
	return fmt.Sprintf("[PATCH /policy/entities/ml-exclusions/v1][%d] updateMLExclusionsV1InternalServerError  %+v", 500, o.Payload)
}

func (o *UpdateMLExclusionsV1InternalServerError) GetPayload() *models.ExclusionsRespV1 {
	return o.Payload
}
