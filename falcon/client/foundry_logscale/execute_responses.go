...
func (o *ExecuteBadRequest) Error() string {
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches/execute/v1][%d] executeBadRequest  %+v", 400, o.Payload)
}
...
func (o *ExecuteNotFound) Error() string {
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches/execute/v1][%d] executeNotFound  %+v", 404, o.Payload)
}
...
func (o *ExecuteInternalServerError) Error() string {
	return fmt.Sprintf("[POST /loggingapi/entities/saved-searches/execute/v1][%d] executeInternalServerError  %+v", 500, o.Payload)
}
