...
func (o *CbExclusionsDeleteV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCbExclusionsDeleteV1OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewCbExclusionsDeleteV1BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 401:
		result := NewCbExclusionsDeleteV1Unauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 403:
		result := NewCbExclusionsDeleteV1Forbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 429:
		result := NewCbExclusionsDeleteV1TooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *CbExclusionsDeleteV1OK) Error() string {
	return fmt.Sprintf("[DELETE /exclusions/entities/cert-based-exclusions/v1][%d] cbExclusionsDeleteV1OK  %+v", 200, o.Payload)
}
...
func (o *CbExclusionsDeleteV1OK) GetPayload() *models.APICertBasedExclusionRespV1 {
	return o.Payload
}

func (o *CbExclusionsDeleteV1OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCbExclusionsDeleteV1BadRequest() *CbExclusionsDeleteV1BadRequest {
	return &CbExclusionsDeleteV1BadRequest{}
}
...
func (o *CbExclusionsDeleteV1BadRequest) Code() int {
	return 400
}

func (o *CbExclusionsDeleteV1BadRequest) Error() string {
	return fmt.Sprintf("[DELETE /exclusions/entities/cert-based-exclusions/v1][%d] cbExclusionsDeleteV1BadRequest  %+v", 400, o.Payload)
}

func (o *CbExclusionsDeleteV1BadRequest) String() string {
	return fmt.Sprintf("[DELETE /exclusions/entities/cert-based-exclusions/v1][%d] cbExclusionsDeleteV1BadRequest  %+v", 400, o.Payload)
}

func (o *CbExclusionsDeleteV1BadRequest) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}

func (o *CbExclusionsDeleteV1BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCbExclusionsDeleteV1Unauthorized() *CbExclusionsDeleteV1Unauthorized {
	return &CbExclusionsDeleteV1Unauthorized{}
}
...
func (o *CbExclusionsDeleteV1Unauthorized) Code() int {
	return 401
}

func (o *CbExclusionsDeleteV1Unauthorized) Error() string {
	return fmt.Sprintf("[DELETE /exclusions/entities/cert-based-exclusions/v1][%d] cbExclusionsDeleteV1Unauthorized  %+v", 401, o.Payload)
}

func (o *CbExclusionsDeleteV1Unauthorized) String() string {
	return fmt.Sprintf("[DELETE /exclusions/entities/cert-based-exclusions/v1][%d] cbExclusionsDeleteV1Unauthorized  %+v", 401, o.Payload)
}

func (o *CbExclusionsDeleteV1Unauthorized) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}

func (o *CbExclusionsDeleteV1Unauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCbExclusionsDeleteV1Forbidden() *CbExclusionsDeleteV1Forbidden {
	return &CbExclusionsDeleteV1Forbidden{}
}
...
func (o *CbExclusionsDeleteV1Forbidden) Code() int {
	return 403
}

func (o *CbExclusionsDeleteV1Forbidden) Error() string {
	return fmt.Sprintf("[DELETE /exclusions/entities/cert-based-exclusions/v1][%d] cbExclusionsDeleteV1Forbidden  %+v", 403, o.Payload)
}

func (o *CbExclusionsDeleteV1Forbidden) String() string {
	return fmt.Sprintf("[DELETE /exclusions/entities/cert-based-exclusions/v1][%d] cbExclusionsDeleteV1Forbidden  %+v", 403, o.Payload)
}

func (o *CbExclusionsDeleteV1Forbidden) GetPayload() *models.MsaspecResponseFields {
	return o.Payload
}

func (o *CbExclusionsDeleteV1Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCbExclusionsDeleteV1TooManyRequests() *CbExclusionsDeleteV1TooManyRequests {
	return &CbExclusionsDeleteV1TooManyRequests{}
}
...
func (o *CbExclusionsDeleteV1TooManyRequests) IsSuccess() bool {
	return false
}
...
func (o *CbExclusionsDeleteV1TooManyRequests) IsCode(code int) bool {
	return code == 429
}

// Code gets the status code for the cb exclusions delete v1 too many requests response
func (o *CbExclusionsDeleteV1TooManyRequests) Code() int {
	return 429
}

func (o *CbExclusionsDeleteV1TooManyRequests) Error() string {
	return fmt.Sprintf("[DELETE /exclusions/entities/cert-based-exclusions/v1][%d] cbExclusionsDeleteV1TooManyRequests  %+v", 429, o.Payload)
}

func (o *CbExclusionsDeleteV1TooManyRequests) String() string {
	return fmt.Sprintf("[DELETE /exclusions/entities/cert-based-exclusions/v1][%d] cbExclusionsDeleteV1TooManyRequests  %+v", 429, o.Payload)
}

func (o *CbExclusionsDeleteV1TooManyRequests) GetPayload() *models.MsaReplyMetaOnly {
	return o.Payload
}

func (o *CbExclusionsDeleteV1TooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
