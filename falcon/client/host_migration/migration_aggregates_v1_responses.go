...
func (o *MigrationAggregatesV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewMigrationAggregatesV1OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewMigrationAggregatesV1BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 403:
		result := NewMigrationAggregatesV1Forbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 429:
		result := NewMigrationAggregatesV1TooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewMigrationAggregatesV1InternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /host-migration/aggregates/migrations/v1] MigrationAggregatesV1", response, response.Code())
	}
}
...
func NewMigrationAggregatesV1OK() *MigrationAggregatesV1OK {
	return &MigrationAggregatesV1OK{}
}
...
func (o *MigrationAggregatesV1OK) Error() string {
	return fmt.Sprintf("[POST /host-migration/aggregates/migrations/v1][%d] migrationAggregatesV1OK  %+v", 200, o.Payload)
}
...
func (o *MigrationAggregatesV1OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewMigrationAggregatesV1BadRequest() *MigrationAggregatesV1BadRequest {
	return &MigrationAggregatesV1BadRequest{}
}
...
func (o *MigrationAggregatesV1BadRequest) Error() string {
	return fmt.Sprintf("[POST /host-migration/aggregates/migrations/v1][%d] migrationAggregatesV1BadRequest  %+v", 400, o.Payload)
}
...
func (o *MigrationAggregatesV1BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewMigrationAggregatesV1Forbidden() *MigrationAggregatesV1Forbidden {
	return &MigrationAggregatesV1Forbidden{}
}
...
func (o *MigrationAggregatesV1Forbidden) Error() string {
	return fmt.Sprintf("[POST /host-migration/aggregates/migrations/v1][%d] migrationAggregatesV1Forbidden  %+v", 403, o.Payload)
}
...
func (o *MigrationAggregatesV1Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewMigrationAggregatesV1TooManyRequests() *MigrationAggregatesV1TooManyRequests {
	return &MigrationAggregatesV1TooManyRequests{}
}
...
func (o *MigrationAggregatesV1TooManyRequests) Error() string {
	return fmt.Sprintf("[POST /host-migration/aggregates/migrations/v1][%d] migrationAggregatesV1TooManyRequests  %+v", 429, o.Payload)
}
...
func (o *MigrationAggregatesV1TooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewMigrationAggregatesV1InternalServerError() *MigrationAggregatesV1InternalServerError {
	return &MigrationAggregatesV1InternalServerError{}
}
...
func (o *MigrationAggregatesV1InternalServerError) Error() string {
	return fmt.Sprintf("[POST /host-migration/aggregates/migrations/v1][%d] migrationAggregatesV1InternalServerError  %+v", 500, o.Payload)
}
...
func (o *MigrationAggregatesV1InternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
